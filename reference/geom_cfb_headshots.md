...
This geom is used to plot CFB player headshots instead of points in a
ggplot. It requires x, y aesthetics as well as a valid ESPN player id
from `cfbfastR`
...
`geom_cfb_headshots()` understands the following aesthetics (required
