...
The code for this package was copied heavily from [nflplotR](https://nflverse.github.io/nflplotR/index.html) with minor changes to support college football team logos.
...
[You can follow this tutorial to see several different uses for `cfbplotR`.](https://kazink36.github.io/cfbplotR/articles/tutorial.html) The key function in the package is `geom_cfb_logo()` which will add college football team logos to a ggplot.
...
-   opening [an issue](https://github.com/Kaink36/cfbplotR/issues/new/choose)
...
-   You can [open an issue](https://github.com/Kazink36/cfbplotR/issues/new/choose) if you’d like to request specific data or report a bug/error.

## Terms of Use

The R code for this package is released as open source under the [MIT License](https://Kazink36.github.io/cfbplotR/docs/LICENSE.html). CFB data accessed by this package belong to their respective owners, and are governed by their terms of use.
