...
#'   team name). `team` should be one of [`valid_team_names()`]. If data includes the variable `tier_rank`,
...
#'   logos will be rendered on each run. If `TRUE` the team names will be
